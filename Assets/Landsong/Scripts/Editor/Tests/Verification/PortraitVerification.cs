...
namespace Landsong.ECS.Editor
{
    public static class PortraitVerification
    {
        ...
        static void People()
        {
            var scene=EditorSceneManager.OpenPreviewScene("Assets/Landsong/GameMaps/Map_Test2/Map_Test2Data/Generated/Map_Test2_Entities.unity");using var store=new BlobAssetStore(128);using var world=new World("Portrait verification",WorldFlags.Game);
            try
            {
