...
namespace Landsong.ECS.Editor
{
    public static class PresentationVerification
    {
        ...
        {
            var scene=EditorSceneManager.OpenPreviewScene("Assets/Landsong/GameMaps/Map_Test2/Map_Test2Data/Generated/Map_Test2_Entities.unity");using var blobs=new BlobAssetStore(128);using var world=new World("Wave fifteen isolated",WorldFlags.Game);
            try
            {
