...
namespace Landsong.ECS.Editor
{
    public static class BuildingCatalogVerification
    {
        public static string Run()
        {
            ...
            foreach (var path in new[] { ApplicationUiAuthoring.BootPath, ApplicationUiAuthoring.StartPath, ApplicationUiAuthoring.LoadingPath, ApplicationUiAuthoring.SettingPath, ApplicationUiAuthoring.SavePath, ApplicationUiAuthoring.ConfirmPath, ApplicationUiAuthoring.GamePath })
            {
