...
namespace Landsong.ECS.Editor
{
    public static class NightPlanningVerification
    {
        ...
        static void Map()
        {
            var scene = EditorSceneManager.OpenPreviewScene("Assets/Landsong/GameMaps/Map_Test2/Map_Test2Data/Generated/Map_Test2_Entities.unity"); using var store = new BlobAssetStore(128); using var world = new World("Wave ten isolated night verification", WorldFlags.Game);
            try
            {
