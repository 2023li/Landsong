...
namespace Landsong.ECS.Editor
{
    ...
    public static class SharedUiPreviewRecipes
    {
        ...
        public static string Run()
        {
            ...
            var start = Load<UI_StartPanel>(ApplicationUiAuthoring.StartPath);
            var pop = Load<UI_StartPanel_GameStartPop>(ApplicationUiAuthoring.UiPath + "StartPanel/UI_StartPanel_GameStartPop.prefab");
            var setting = Load<UI_SettingPanel>(ApplicationUiAuthoring.SettingPath);
            var save = Load<UI_SavePanel>(ApplicationUiAuthoring.SavePath);
