...
namespace Landsong.Editor.UI
{
    public static class UiPanelLayoutAuthoring
    {
        ...
        public static string RepairAllRoots()
        {
            ...
            int count = 0;
            foreach (var path in new[] { ApplicationUiAuthoring.BootPath, ApplicationUiAuthoring.StartPath,
                ApplicationUiAuthoring.LoadingPath, ApplicationUiAuthoring.SettingPath, ApplicationUiAuthoring.SavePath,
                ApplicationUiAuthoring.ConfirmPath, ApplicationUiAuthoring.GamePath })
            {
