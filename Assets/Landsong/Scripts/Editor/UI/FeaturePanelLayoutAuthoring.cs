...
namespace Landsong.ECS.Editor
{
    public static class FeaturePanelLayoutAuthoring
    {
        ...
        public static void ReserveHudFooter()
        {
            ...
            var contents = PrefabUtility.LoadPrefabContents(ApplicationUiAuthoring.GamePath);
            try
            {
                ...
                if (PrefabUtility.SaveAsPrefabAsset(contents, ApplicationUiAuthoring.GamePath) == null)
