...
namespace Landsong.ECS.Editor
{
    public static class FinalizeSharedUiAssets
    {
        public static string Run()
        {
            ...
            Edit<UI_StartPanel_GameStartPop>(ApplicationUiAuthoring.UiPath + "StartPanel/UI_StartPanel_GameStartPop.prefab", pop =>
            {
            ...
            Edit<UI_StartPanel>(ApplicationUiAuthoring.StartPath, menu => NormalizeButtons(menu.gameObject));
            Edit<UI_SettingPanel>(ApplicationUiAuthoring.SettingPath, setting =>
            {
            ...
            Edit<UI_SavePanel>(ApplicationUiAuthoring.SavePath, save =>
            {
