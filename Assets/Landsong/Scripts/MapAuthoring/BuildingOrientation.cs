...
namespace Landsong.GridSystem
{
    ...
    public static class BuildingOrientationUtility
    {
        ...
        public static Vector2Int GetEffectiveSize(this BuildingOrientation orientation, Vector2Int baseSize)
        {
            ...
            return orientation.SwapsFootprintAxes() ? new Vector2Int(baseSize.y, baseSize.x) : baseSize;
        }
        ...
        public static Quaternion ToWorldRotation(this BuildingOrientation orientation, GridPlaneMode planeMode)
        {
            ...
            return planeMode == GridPlaneMode.XZ || planeMode == GridPlaneMode.IsometricDiamondXZ ? Quaternion.Euler(0f, degrees, 0f) : Quaternion.Euler(0f, 0f, -degrees);
        }

        public static BuildingOrientation FromWorldRotation(Quaternion rotation, GridPlaneMode planeMode)
        {
            var angle = planeMode == GridPlaneMode.XZ || planeMode == GridPlaneMode.IsometricDiamondXZ ? rotation.eulerAngles.y : -rotation.eulerAngles.z;
