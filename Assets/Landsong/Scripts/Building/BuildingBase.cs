...
namespace Landsong.BuildingSystem
{
    ...
    public abstract class BuildingBase : MonoBehaviour
    {
        ...
        /// </summary>
        internal void SetPlacement(GridPosition newGridPosition, string newGridOccupancyId)
        {
        ...
        /// <summary>
        /// 建筑销毁时自动从 GameSystem 注销，避免回合列表继续持有已经销毁的对象。
        /// 子类如果重写 OnDestroy，需要调用 base.OnDestroy()。
        /// </summary>
