...
namespace Landsong.ECS.Presentation
{
    ...
    public sealed class UI_GamePanel_BuildingCatalogBar : MonoBehaviour
    {
        ...
        readonly Dictionary<BuildingId, UI_GamePanel_BuildingCatalogCard> cards = new Dictionary<BuildingId, UI_GamePanel_BuildingCatalogCard>();
        ...
        Action<BuildingId> choose;
        BuildingId hovered;
        public bool HasCategory(BuildingCategory category) => tabs.ContainsKey(category);
        public Button CardButton(BuildingId definition) => cards.TryGetValue(definition, out var card) ? card.Select : null;
        ...
        public void Bind(List<BuildingCatalogCard> values, Action<BuildingId> onChoose, string hint)
        {
        ...
        public void ShowTooltip(BuildingId definition)
        {
