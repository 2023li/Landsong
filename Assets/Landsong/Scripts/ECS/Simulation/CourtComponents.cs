...
{
    [System.Serializable]
    public struct CourtSettings : IComponentData
    {
        [LabelText("最低婚龄")]
        ...
        public static CourtSettings Default => new CourtSettings
        {
            ...
            MarriageRequestChance = .12f,
            MarriageRefusalGrievanceChance = .5f,
            MarriageRefusalGrievance = .2f,
            ExpeditionRequestCooldown = 8,
            ExpeditionRequestChance = .08f,
            ...
            RegicideChance = .08f,
            PrinceRisk = .25f,
            StableProduction = .05f,
            StableAttack = .05f,
            WeakProduction = -.1f,
            WeakAttack = -.05f,
            ElectionProduction = -.15f,
            ElectionAttack = -.1f,
            UsurpProduction = -.25f,
            UsurpAttack = -.2f,
            RegicideProduction = -.35f,
            RegicideAttack = -.3f,
            DisorderPerStack = .05f,
            DisorderCap = .25f,
            DeathYoung = .001f,
            DeathAdult = .003f,
            DeathMature = .015f,
    ...
    public struct CourtLogEntry : IBufferElementData
    {
        public int Turn;
        public ulong Person;
    ...
    public enum PersonRequestKind : byte
    {
        Marriage,
        Expedition,
        SocialTask,
    ...
    public enum PersonRequestStatus : byte
    {
        Pending,
        Travelling,
        Completed,
    ...
    [InternalBufferCapacity(0)]
    public struct PersonRequestEntry : IBufferElementData
    {
        public PersonRequestKind Kind;
        public PersonRequestStatus Status;
        public int CreatedTurn, ResolvedTurn;
