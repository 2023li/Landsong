...
namespace Landsong.ECS.Persistence
{
    ...
    public static class SnapshotCodec
    {
        ...
        static int Header(BinaryReader reader)
        {
            ...
            if (version != 33 && version != 34 && version != 35 && version != 36 && version != 37 && version != CurrentVersion)
        ...
        public sealed class Snapshot
        {
            ...
            public QuestRefreshCooldown[] QuestRefreshCooldowns = Array.Empty<QuestRefreshCooldown>();
        ...
        static void RebuildCore(EntityManager em, Entity root, Snapshot snapshot, bool deferQuestContainerReconciliation, Action<string> probe)
        {
            ...
            em.GetBuffer<TransportDeliveryEvent>(root).Clear();
