...
namespace Moyo.Unity
{
    ...
    /// Moyo 各运行时模块共享的项目配置。
    /// </summary>
    [CreateAssetMenu(fileName = AddressableKey, menuName = "MoyoUnity/MoyoConfig")]
    public sealed class MoyoConfig : SingletonScriptableObject<MoyoConfig>
    {
        ...
        public static Task<MoyoConfig> LoadAsync(string addressableKey = AddressableKey)
        {
